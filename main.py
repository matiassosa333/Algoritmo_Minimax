...
def main():
    ...
    while turnos < MAX_TURNOS:
        ...
        mov_raton = mejor_movimiento_raton(gato, raton, PROFUNDIDAD, FILAS, COLUMNAS)
        ...
        mov_gato = mejor_movimiento_gato(gato, raton, PROFUNDIDAD, FILAS, COLUMNAS)
    ...
    colocar_personajes(tablero, gato, raton)
    mostrar_tablero(tablero)
    print("Empate o escape del ratón por límite de turnos.")
